...
namespace ProjectMercury.Proxies
{
    ...
    public class ParticleEffectProxy
    {
        ...
        /// </summary>
        public void Trigger(ref BoundingFrustum frustum, Boolean checkNearFar = false)
        {
        ...
        /// </summary>
        public void Trigger(BoundingFrustum[] frustums, Boolean checkNearFar = false)
        {
        ...
        /// The effect will be checked against the frustum and culled if not within the effect Bounding Radius
        /// </summary>
        public void Trigger(ref BoundingFrustum frustum, Matrix world, Boolean checkNearFar = false)
        {
            Matrix finalWorld;
        ...
        /// The effect will be checked against the frustums and culled if not within the effect Bounding Radius
        /// </summary>
        public void Trigger(BoundingFrustum[] frustums, Matrix world, Boolean checkNearFar = false)
        {
            Matrix finalWorld;
            Matrix.Multiply(ref World, ref world, out finalWorld);
